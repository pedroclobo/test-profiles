...
cd simdjson-2.0.4
sed -i -E 's/operator[[:space:]]+""[[:space:]]+_/operator""_/g' singleheader/simdjson.h
sed -i -E 's/operator[[:space:]]+""[[:space:]]+_/operator""_/g' include/simdjson/padded_string-inl.h
sed -i -E 's/operator[[:space:]]+""[[:space:]]+_/operator""_/g' include/simdjson/padded_string.h
